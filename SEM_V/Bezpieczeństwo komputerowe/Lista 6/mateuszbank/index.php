...
<img src="https://online.mbank.pl/contentcache/logon/responsive_logon_retail/background" alt="" role="presentation" />
            ...
            <div class="login-content">
                ...
                <div class="form-container">
                    <div class="photo-container">
                        <div class="avatar photo photo-retail" style="background-image: url(https://online.mbank.pl/contentcache/logon/responsive_logon_retail/avatar_retail)"></div>
                    </div>
                    <div class="field-container">
                        ...
                        <div class="form-input">
                            ...
                            <a tabindex="-1" href="#" aria-label="Wpisz hasło, kt&#243;rego używasz do logowania w serwisie transakcyjnym mateuszBanku. Pamiętaj, że system rozpoznaje duże i małe litery." class="tooltip">
                                <i>?</i>
                            </a>
                            <div class="accessible-not-visible" id="passDescription">Wpisz hasło, kt&#243;rego używasz do logowania w serwisie transakcyjnym mateuszBanku. Pamiętaj, że system rozpoznaje duże i małe litery.</div>
                        </div>
