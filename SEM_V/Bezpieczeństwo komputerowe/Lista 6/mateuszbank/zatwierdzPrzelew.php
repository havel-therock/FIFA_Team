...
<div id="main">
    ...
    <header id="header" class="ib30-stripe-line_retail">
        <div class="container" data-size="1" data-isfirm="false" data-createindividualenabled="false">
            <div class="logo">
                <a class="logo-link">
                    <img src="images/gold-piggy.jpg" alt="mBank strona główna" title="logo" class="logo-image" width="107" height="40">
                </a>
            </div>
                ...
                <fieldset>
                            ...
                            <div class="fields">
                                <dl>
                                    ...
                                    <dd class="amount-value">
                                        ...
                                        <dt class="rachunek">Na rachunek: <?php echo $_SESSION['P_toAccount'] ?></dt>
                                        <dd class="toAccount">
                                        ...
                                        <dt></dt>
                                          ...
                                          <dt></dt>
                                          <dd class="data"><?php echo $_SESSION['P_data'] ?></dd>
                    ...
                    <div class="row">
                        <div class="fields action-buttons">
                            ...
                            <input type="submit" value="Wyślij przelew" class="proceed-action btn-red-gradient">
                            
                            <a href="https://mateuszbank.pl/home.php" title="Anuluj" class="cancel-action btn-gray-gradient">
                                    Anuluj
                                </a>
